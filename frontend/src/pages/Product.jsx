...
const Product = () => {
    ...
    return productData ? (
        <div className='border-t-2 p-10 transition-opacity ease-in duraion-500 opacity-100'>
            {/* -------------Product Data------------- */}
            <div className='flex gap-12 sm:gap-12 flex-col sm:flex-row'>
                ...
                <div className='flex-1'>
                    ...
                    text-sm active:bg-gray-700'>ADD TO CART</button>
        ...
        <div className='mt-20'>
            ...
            text-gray-500'>
                <p>An e-commerce website is a website that sells products or services online.</p>
                <p>E-commerce websites typically display products or services along with detailed
                information, images, and reviews and details section </p>
            </div>
        </div>
